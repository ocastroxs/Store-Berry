...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const allLoginButtons = [btnLoginHeader, btnLoginFooter].filter(
    (btn) => btn !== null
  );
...
function showUserMenu(btnLogin, isFooter) {
  ...
  document.getElementById("btnLogout").addEventListener("click", async (e) => {
    ...
    try {
      ...
      // Se o servidor indica que limpou o carrinho, também limpa o localStorage
      if (data.clearClientCart) {
